...
class M_Paket extends CI_Model {
    ...
    {
        $this->db->select();
        $this->db->from("mst_paketheader");
        $this->db->where("StatusPaket != 0");
        $q = $this->db->get();
        return $q->result();
    }
    ...
    public function GetSubPaket($IdPaket)
    {
        $this->db->select();
        $this->db->from("mst_paketdetail");
    ...
    public function delHeaderPaket($IdPaket)
    {
        $this->db->where('IdPaket', $IdPaket);
        $this->db->delete("mst_paketheader");
    }
    public function delDetailPaket($IdPaket)
    {
        $this->db->where('IdPaket', $IdPaket);
        $this->db->delete("mst_paketdetail");
    }
