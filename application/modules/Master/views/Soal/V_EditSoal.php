      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <a href="<?=base_url()?>Master/Soal/SubSoalDetail/<?=$id_subsoal?>" class="btn btn-sm btn-warning" ><i class="fas fa-backward"></i> Kembali</a>
              <br><br>
              <form action="<?=base_url()?>Master/Soal/SimpanEditSoal" method="post" enctype="multipart/form-data">
              ...
              <table>
                ...
                <tr>
                  <td><input type="text" name="Baris" id="Baris" class='form-control' style='width: 70px' value='<?=$data_subsoal->Baris?>'></td>
                  <td><input type="text" name="Kolom" id="Kolom" class='form-control' style='width: 70px' value='<?=$data_subsoal->Kolom?>'></td>
                </tr>
              </table>
