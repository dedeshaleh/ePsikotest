          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="custom-control custom-checkbox">
                  <input class="custom-control-input custom-control-input-primary" name="TypeJawaban" type="checkbox" id="CheckDISC" onclick="GetCheckDisc()" value='3'>
                  <label for="CheckDISC" class="custom-control-label">Pilihan DISC</label>
                </div>
              </div>
              ...
              <table>
                <tr>
                  <td><label for="">Baris</label></td>
                  <td><label for="">Kolom</label></td>
                </tr>
                <tr>
                  <td><input type="text" name="Baris" id="Baris" class='form-control' style='width: 70px'></td>
                  <td><input type="text" name="Kolom" id="Kolom" class='form-control' style='width: 70px'></td>
                </tr>
              </table>
              ...
              <div class="form-group"  id="DiscChoice">
                <button type="button" class="btn btn-sm btn-success" id="addDisc"><i class="fas fa-plus"></i> Tambah Jawaban</button>
                <br><br>
                <div class="table-responsive">
                  <table class="table table-sm table-bordered">
                    <thead>
...
<script>
  ...
  $('#add').click(function(){
      ...
      <tr id="row`+i+`">
        ...
        <td>
            <div class="input-group ">
                <input type="text" id="Score`+i+`" name="Score[]" class="form-control" style="max-width:100px">
            </div>
        </td>
...
$(document).ready(function(){
      ...
      <tr id="discrow`+i+`">
        <td>
          <div class="custom-control ">
            <input  name="TypeJawab[]" type="text"  value='1' hidden>
            <label for="Check`+i+`" >Text</label>
          </div>
        ...
        <td>
        <div class="input-group"><input type="text" name="files[]" class="form-control"></div>
        </td>
        <td>
        <div class="input-group input-wrapper"><input type="text" name="Plus[]" class="form-control" style="max-width:50px;"></div>
        </td>
        <td>
        <div class="input-group input-wrapper"><input type="text" name="Minus[]" class="form-control" style="max-width:50px;"></div>
        </td>
        
        <td><button type="button" name="remove" id="`+i+`" class="btn btn-danger btn_removedisc">X</button></td>
    </tr>
      `
       $('#disc_field').append(html);
       $('.select2bs4').select2({
      theme: 'bootstrap4'
    })
  });
  ...
  $(document).on('click', '.btn_removedisc', function(){
      var button_id = $(this).attr("id");
      $('#discrow'+button_id+'').remove();
      });
});  
...
function GetCheck(kolomId) {
  if (kolomId != null) {
    ...
    document.getElementById('CheckDISC').checked = false;
    document.getElementById('MultiChoice').hidden = true;
    document.getElementById('DiscChoice').hidden = true;
...
function GetCheckDisc(kolomId) {
  if (kolomId != null) {
    ...
    document.getElementById('Pilihan').hidden = true;  
    document.getElementById('MultiChoice').hidden = true;
    document.getElementById('DiscChoice').hidden = false;
    document.getElementById('add').hidden = false;
  }
