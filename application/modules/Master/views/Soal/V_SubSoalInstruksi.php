...
<form action="<?=base_url()?>Master/Soal/SubDetailInstruksiDelete" method="post" enctype="multipart/form-data">
      ...
      { data: 'TypeJawaban', 
        render: function (data, type, row, meta) {
          ...
          if (menu_akses.edit_level == 'Y') {
            ...
            var edit = '<a href="<?=base_url()?>Master/Soal/EditSoalInstruksi/'+row.id_soalinstruksi+'" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i> Edit</a>'
          }else{
            var edit = '';
          }
