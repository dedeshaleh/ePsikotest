        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <br><br>
              <form action="<?=base_url()?>Master/Soal/SimpanSoalInstruksi" method="post" enctype="multipart/form-data">
...
<script>
  ...
  $('#add').click(function(){
      ...
      <tr id="row`+i+`">
        ...
        <td>
          <div class="input-group ">
            <textarea required id="KetJawaban`+i+`" name="KetJawaban[]" class="form-control"  >
            </textarea>
          </div>
        </td>
