...
class WelcomePage extends MY_Controller
{
    //
    public $CI;
    ...
    public function index()
    {
        ...
        $data['DataWelcome'] = $this->db->query("SELECT * FROM tbl_welcome Order by CreateDate DESC LIMIt 1")->row();
        $this->template->backend('WelcomePage/index',$data);
    }
    ...
    {
        $data = array(
            'HeaderPage' => $this->input->post('HeaderPage'),
            'WelcomePage' => $this->input->post('WelcomePage'),
            'FooterPage' => $this->input->post('FooterPage'),
