...
class LaporanKandidat extends MY_Controller
{
    //
    public $CI;
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        $this->load->model("M_LaporanKandidat");
    }
    ...
    public function data_detail()
    {
        ...
        $hasil = array(
            'draw' => $_POST['draw'],
            'recordsTotal' => $this->M_LaporanKandidat->count_all(),
            'recordsFiltered' => $this->M_LaporanKandidat->count_filtered(),
            "data" => $this->M_LaporanKandidat->get_datatables(),
        );
